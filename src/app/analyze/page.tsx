...
function AnalyzeContent() {
  ...
  const renderCardContent = (figId: string, isZoomed = false) => {
    switch (figId) {
      case "fig-01":
        return (
          <div className="flex flex-col h-full justify-between">
            ...
            {loading ? (
              ...
              <div className="mb-4">
                ...
                <p className="text-[11px] text-gray-600 mt-1" style={{ display: "-webkit-box", WebkitLineClamp: isZoomed ? 4 : 2, WebkitBoxOrient: "vertical", overflow: "hidden" }}>{report.metadata.description}</p>
      ...
      case "fig-03":
        return (
          <div className="flex flex-col h-full justify-between">
            ...
            {report ? (
              <div
                className={`w-full ${isZoomed ? "h-64" : "h-36"} flex items-center justify-center p-1 border border-black bg-neutral-50 overflow-auto`}
        ...
        return (
          <div className="flex flex-col h-full justify-between">
            ...
            <div className="flex gap-4">
              <div className={`w-2/5 border-r border-black pr-2 space-y-1 text-xs overflow-y-auto ${isZoomed ? "max-h-56" : "max-h-36"} font-mono`}>
                {report ? (
                  <div className="space-y-1">
                    <div className="font-bold">📁 {report.metadata.repo}/</div>
                    {report.folderTree.children?.slice(0, isZoomed ? 12 : 8).map((child) => (
                      <div
                        key={child.path}
              ...
              <div className="grow">
                {report ? (
                  <div className={`border border-black p-2 ${isZoomed ? "h-48" : "h-28"} bg-neutral-50 overflow-y-auto text-[10px] font-mono`}>
      ...
      case "fig-05":
        return (
          <div className="flex flex-col h-full justify-between">
            ...
            {report ? (
              <div className={`${isZoomed ? "h-56" : "h-36"} overflow-y-auto pr-1`}>
      ...
      case "fig-06":
        return (
          <div className="flex flex-col h-full justify-between">
            ...
            <div className={`border border-black bg-white shadow-md p-3 ${isZoomed ? "h-56" : "h-40"} relative overflow-y-auto font-mono text-[10px] leading-relaxed`}>
              {report ? (
      ...
      case "fig-07":
        return (
          <div className="flex flex-col h-full justify-between">
            ...
            {report ? (
              <div className={`border border-black ${isZoomed ? "h-44" : "h-28"} p-2 overflow-y-auto text-[9px] font-mono bg-neutral-50 whitespace-pre-wrap`}>
      ...
      case "fig-08":
        return (
          <div className="flex flex-col h-full justify-between">
            ...
            {report ? (
              <div className={`overflow-y-auto text-[10px] space-y-1 font-mono ${isZoomed ? "h-44" : "h-28"}`}>
      ...
      case "fig-09":
        return (
          <div className="flex flex-col h-full justify-between">
            ...
            {report ? (
              <div className={`overflow-y-auto text-[10px] space-y-1.5 font-mono ${isZoomed ? "h-44" : "h-28"}`}>
                ...
                {report.codeQuality.issues.map((issue) => (
                  <div key={issue.id} className="border-l-2 border-black pl-1 text-[9px]">
                    ...
                    <div className="text-gray-600 line-clamp-2">{issue.description}</div>
                  </div>
                ))}
      ...
      case "fig-10":
        return (
          <div className="flex flex-col h-full justify-between">
            ...
            {report ? (
              <div className={`overflow-y-auto text-[10px] space-y-2 font-mono ${isZoomed ? "h-44" : "h-28"}`}>
                <div className="flex justify-between border-b border-black pb-1 font-bold">
      ...
      case "fig-11":
        return (
          <div className="flex flex-col h-full justify-between">
            ...
            <div className="flex gap-4">
              <div className={`grow ${isZoomed ? "h-36" : "h-24"} overflow-y-auto text-[10px] font-mono border border-black p-2 bg-white`}>
                {report ? (
                  <div>
              ...
              <div className={`w-16 h-16 border-2 border-black rounded-full relative shrink-0 bg-white flex items-center justify-center ${isZoomed ? "mt-6" : "mt-2"}`}>
        ...
        return (
          <div className="flex flex-col h-full justify-between">
            ...
            <div className="flex gap-4">
              ...
              <div className={`w-20 space-y-2 shrink-0 ${isZoomed ? "mt-6" : "mt-2"}`}>
      ...
      case "fig-13":
        return (
          <div className="flex flex-col h-full justify-between">
            ...
            <div className="flex gap-4">
              <div className={`flex-1 border border-black p-2 relative overflow-y-auto ${isZoomed ? "h-36" : "h-24"} bg-white text-[9px] font-mono`}>
                {report ? (
                  <div>
              ...
              <div className={`w-16 flex flex-col items-center justify-center gap-1 shrink-0 ${isZoomed ? "pt-6" : "pt-2"}`}>
    ...
    >
      ...
      <div className="max-w-[1340px] mx-auto border-4 border-black p-1 bg-white relative">
        ...
        <div className="flex gap-4 p-1">
          ...
          {/* ── Left Sidebar ── */}
          <aside className="w-56 shrink-0 z-50 relative bg-white/90 p-2 rounded-lg sketch-border">
            <div className="mb-6">
          ...
          <main className="grow grid grid-cols-12 gap-4">
            <div id="fig-01" className="col-span-4 sketch-border p-4 h-64 relative overflow-hidden transition-all duration-300">
              <span className="fig-label">FIG. 01</span>
              {renderCardContent("fig-01")}
            </div>
            <div id="fig-02" className="col-span-4 sketch-border p-4 h-64 relative transition-all duration-300">
              <span className="fig-label">FIG. 02</span>
              {renderCardContent("fig-02")}
            </div>
            <div id="fig-03" className="col-span-4 sketch-border p-4 h-64 relative overflow-hidden transition-all duration-300">
              <span className="fig-label">FIG. 03</span>
              {renderCardContent("fig-03")}
            </div>
            <div id="fig-04" className="col-span-4 sketch-border p-4 h-64 relative overflow-hidden transition-all duration-300">
              <span className="fig-label">FIG. 04</span>
              {renderCardContent("fig-04")}
            </div>
            <div id="fig-05" className="col-span-4 sketch-border p-4 h-64 relative overflow-hidden transition-all duration-300">
              <span className="fig-label">FIG. 05</span>
              {renderCardContent("fig-05")}
            </div>
            <div id="fig-06" className="col-span-4 sketch-border p-4 h-64 relative overflow-hidden transition-all duration-300">
              <span className="fig-label">FIG. 06</span>
              {renderCardContent("fig-06")}
            </div>
            <div id="fig-07" className="col-span-3 sketch-border p-4 h-56 relative overflow-hidden transition-all duration-300">
              <span className="fig-label">FIG. 07</span>
              {renderCardContent("fig-07")}
            </div>
            <div id="fig-08" className="col-span-3 sketch-border p-4 h-56 relative overflow-hidden transition-all duration-300">
              <span className="fig-label">FIG. 08</span>
              {renderCardContent("fig-08")}
            </div>
            <div id="fig-09" className="col-span-3 sketch-border p-4 h-56 relative overflow-hidden transition-all duration-300">
              <span className="fig-label">FIG. 09</span>
              {renderCardContent("fig-09")}
            </div>
            <div id="fig-10" className="col-span-3 sketch-border p-4 h-56 relative overflow-hidden transition-all duration-300">
              <span className="fig-label">FIG. 10</span>
              {renderCardContent("fig-10")}
            </div>
            <div id="fig-11" className="col-span-4 sketch-border p-4 h-48 relative overflow-hidden transition-all duration-300">
              <span className="fig-label">FIG. 11</span>
              {renderCardContent("fig-11")}
            </div>
            <div id="fig-12" className="col-span-4 sketch-border p-4 h-48 relative overflow-hidden transition-all duration-300">
              <span className="fig-label">FIG. 12</span>
              {renderCardContent("fig-12")}
            </div>
            <div id="fig-13" className="col-span-4 sketch-border p-4 h-48 relative overflow-hidden transition-all duration-300">
              <span className="fig-label">FIG. 13</span>
              {renderCardContent("fig-13")}
            </div>
          </main>
        ...
        {/* ── Zoomed Inspector Overlay Modal (40% larger) ── */}
        {activeSection && activeSection !== "Overview" && activeSection !== "" && (() => {
          const activeItem = sidebarItems.find(item => item.label === activeSection);
          if (!activeItem) return null;
          const figNum = activeItem.figId.replace("fig-", "");

          return (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/45 backdrop-blur-sm transition-all duration-300">
              <div className="absolute inset-0 cursor-zoom-out" onClick={() => setActiveSection("")} title="Dismiss zoom overlay" />
              <div className="sketch-border p-6 bg-white w-[560px] h-[380px] relative z-10 shadow-2xl flex flex-col justify-between transition-all duration-300 transform scale-100 overflow-hidden">
                <button 
                  onClick={() => setActiveSection("")} 
                  className="absolute top-2 right-4 font-bold text-gray-500 hover:text-black transition-colors text-lg cursor-pointer"
                  title="Close Inspector"
                >
                  ✕
                </button>
                <span className="fig-label text-xs">FIG. {figNum}</span>
                {renderCardContent(activeItem.figId, true)}
              </div>
            </div>
          );
        })()}
